...
namespace VsForceUtf8
{
    ...
    [Name(StatusBarEncodingMargin.MarginName)]
    ...
    internal sealed class StatusBarEncodingMarginFactory : IWpfTextViewMarginProvider
    {
        ...
        public IWpfTextViewMargin CreateMargin(IWpfTextViewHost wpfTextViewHost, IWpfTextViewMargin marginContainer)
        {
            ...
            return roles.Contains("DOCUMENT")
                ...
                ? new StatusBarEncodingMargin(wpfTextViewHost.TextView, marginContainer)
                : null;
        }
